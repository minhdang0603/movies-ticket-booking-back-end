...
public class ShowService {
    ...
    public List<ShowResponse> getShows(Optional<String> cinemaId, Optional<String> movieId, Optional<String> cityId, Optional<String> date) {
        ...
        var shows = showRepository.findShowsByOptionalParams(cinemaIdStr, movieIdStr, cityIdStr, localDate)
                .orElse(null);
    ...
    public ShowResponse getShowById(String showId) {
        return showMapper.toShowResponse(showRepository.findById(showId)
